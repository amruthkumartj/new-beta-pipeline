/**
 * DEPRECATED: GitHub Webhook Deployment Handler
 *
 * This file implements webhook-based CI/CD for backward compatibility.
 * 
 * ⚠️ RECOMMENDED MIGRATION:
 * For new deployments, use AWS CodePipeline + CodeBuild instead (see ../terraform/).
 *
 * Benefits of CodePipeline:
 * ✓ Native AWS integration with full audit trail
 * ✓ No webhooks = no internet exposure required
 * ✓ Fine-grained IAM roles
 * ✓ Automatic rollback on failure
 * ✓ Better secret management
 *
 * Migration Path:
 * 1. Deploy Terraform infrastructure (see ../terraform/README.md)
 * 2. Test CodePipeline deployment
 * 3. Remove this webhook route from server.js
 * 4. Delete this file
 *
 * For now, this endpoint remains functional for backward compatibility.
 */
...
//
// ⚠️ SECURITY WARNING:
//   Webhooks expose your application to internet.
//   If your app is compromised, attackers can trigger deployments.
//   Use CodePipeline instead to isolate deployment logic.
// ─────────────────────────────────────────────
